...
def get_args_parser():
    ...
    parser.add_argument('--sam2_version', default='base', type=str, choices=['tiny', 'base', 'large'],
                        help="Version of SAM2 image encoder to use (preset)")
    parser.add_argument('--sam2_config', default='', type=str,
                        help="Optional Hydra config (relative to 'sam2' config root), e.g., 'sam2_configs/edgetam_hiera.yaml'")
    parser.add_argument('--sam2_checkpoint', default='', type=str,
                        help="Optional checkpoint path to override preset weights (e.g., EdgeTAM/checkpoints/edgetam.pt)")
